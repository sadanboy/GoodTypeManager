...
type
   TVSOP87D_COEFFICIENT=record
      A:Double;
      B:Double;
      C:Double;
   end;
const
  Earth_L0:array[0..63] of TVSOP87D_COEFFICIENT=(
...
Earth_L1:array[0..33] of TVSOP87D_COEFFICIENT=(
...
{L2 -------------------------}
Earth_L2:Array[0..19]  of TVSOP87D_COEFFICIENT=(
...
Earth_L3:Array[0..6]  of TVSOP87D_COEFFICIENT=(
...
Earth_L4:Array[0..2]  of TVSOP87D_COEFFICIENT=(
...
Earth_L5:Array[0..0]  of TVSOP87D_COEFFICIENT=(
...
Earth_B0:Array[0..4]  of TVSOP87D_COEFFICIENT=(
...
Earth_B1:Array[0..1]  of TVSOP87D_COEFFICIENT=(
{1} (A:      9.03000000 ;B:      3.89729062 ;C:   5507.55323867),
{2} (A:      6.17700000 ;B:      1.73038850 ;C:   5223.69391980));

 {B2 -------------------------}
Earth_B2:Array[0..3]  of TVSOP87D_COEFFICIENT=(
{1}  (A:22378.0 ;B: 3.38509 ; C:10213.28555  ),
{2}  (A:  282.0 ;B: 0.00000 ; C:00000.00000  ),
{3}  (A:  173.0 ;B: 5.25600 ; C: 20426.57100 ),
{4}  (A:   27.0 ;B: 3.87000 ; C: 30639.86000 ));

{B3 -------------------------}
Earth_B3:Array[0..3]  of TVSOP87D_COEFFICIENT=(
{1}  (A:647.0 ;B: 4.992 ;C: 10213.286 ) ,
{2}  (A:20.0  ; B:3.140 ;C: 00000.000 ),
{3}  (A:6.0 ; B:0.770 ; C:20426.570 ),
{4}  (A:   3.0 ;B: 5.440 ;C: 30639.860));

{B4 -------------------------}
Earth_B4:Array[0..0]  of TVSOP87D_COEFFICIENT=(
   (A:14.0 ;B: 0.32 ;C: 10213.29 )
);

Earth_R0:Array[0..39]  of TVSOP87D_COEFFICIENT=(
...
Earth_R1:Array[0..9]  of TVSOP87D_COEFFICIENT=(
...
Earth_R2:Array[0..5]  of TVSOP87D_COEFFICIENT=(
